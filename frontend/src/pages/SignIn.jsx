...
function SignIn() {
  return (
    <div className=" flex-col justify-center h-screen w-screen bg-gray-200">
      ...
      <div className="flex items-center justify-center">
        <button
          type="button"
          className="bg-[#1ba500] text-white m-1 py-1 px-4 mt-24 rounded-lg shadow-lg h-14 w-44 md:h-14 md:w-44 md:text-lg hover:shadow hover:bg-[#FFC927] hover:text-black"
        >
          Connexion
        </button>
      </div>
