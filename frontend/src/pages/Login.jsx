        ...
        <div className="mt-16 mx-12  bg-gray-400 py-4 px-4 h-1/2 md:w-1/3 md:mx-auto">
          <form onSubmit={handleSubmit} className="m-auto mt-5">
            ...
            <div className="flex flex-col items-center justify-center">
              <button
                type="submit"
                className="h-14 2/5 mr-2 mb-8 bg-green-600 opacity-60 hover:opacity-100 hover:text-white  text-white border-solid border-2 rounded-lg hover:scale-105 duration-300 border-black"
              >
                Connexion
              </button>
              <LogOut />
